...
from .feed import LatestSkosCollectionRssFeed, LatestSkosCollectionAtomFeed
...
urlpatterns = [
    ...
    # feeds
    path('concepts/feed/rss', LatestSkosCollectionRssFeed(), name="skoscollection_rss_feed"),
    path('concepts/feed/atom', LatestSkosCollectionAtomFeed(), name="skoscollection_atom_feed"),
    # sitemap
